...
export function MobileDrawer({ open, onClose }: MobileDrawerProps) {
  ...
  // Trava o scroll da pagina enquanto o drawer esta aberto, preservando a
  // posicao atual (position: fixed) para nao quebrar o header sticky quando o
  // usuario ja tiver rolado a pagina.
  useEffect(() => {
    if (!open) return;
